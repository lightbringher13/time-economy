package com.timeeconomy.auth_service.adapter.out.jpa.phoneverification;

import com.timeeconomy.auth_service.domain.phoneverification.model.PhoneVerification;
import com.timeeconomy.auth_service.domain.phoneverification.port.out.PhoneVerificationRepositoryPort;
import com.timeeconomy.auth_service.adapter.out.jpa.phoneverification.entity.PhoneVerificationEntity;
import com.timeeconomy.auth_service.adapter.out.jpa.phoneverification.mapper.PhoneVerificationMapper;
import com.timeeconomy.auth_service.adapter.out.jpa.phoneverification.repository.PhoneVerificationJpaRepository;
