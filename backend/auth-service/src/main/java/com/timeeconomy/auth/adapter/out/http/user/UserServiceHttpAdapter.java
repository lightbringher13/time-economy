package com.timeeconomy.auth.adapter.out.http.user;
...
import com.timeeconomy.auth.adapter.out.http.user.dto.CreateUserProfileRequest;
import com.timeeconomy.auth.domain.common.integration.port.UserProfileSyncPort;
